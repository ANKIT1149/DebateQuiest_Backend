...
SCHEMA_PATH = Path('C:/Users/aryan/OneDrive/Desktop/Aryansh_Workspace/Development Project/DebateQuiestBackend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\aryan\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    quizzes: 'actions.quizzesActions[models.quizzes]'
    quiz_result: 'actions.quiz_resultActions[models.quiz_result]'
    user_progress: 'actions.user_progressActions[models.user_progress]'
    bookmark_quiz: 'actions.bookmark_quizActions[models.bookmark_quiz]'
    debatesession: 'actions.DebateSessionActions[models.DebateSession]'
    message: 'actions.MessageActions[models.Message]'
    companion_create: 'actions.companion_createActions[models.companion_create]'
    interaction: 'actions.InteractionActions[models.Interaction]'
    ...
    def __init__(
        ...
        *,
        ...
        self.quizzes = actions.quizzesActions[models.quizzes](self, models.quizzes)
        self.quiz_result = actions.quiz_resultActions[models.quiz_result](self, models.quiz_result)
        self.user_progress = actions.user_progressActions[models.user_progress](self, models.user_progress)
        self.bookmark_quiz = actions.bookmark_quizActions[models.bookmark_quiz](self, models.bookmark_quiz)
        self.debatesession = actions.DebateSessionActions[models.DebateSession](self, models.DebateSession)
        self.message = actions.MessageActions[models.Message](self, models.Message)
        self.companion_create = actions.companion_createActions[models.companion_create](self, models.companion_create)
        self.interaction = actions.InteractionActions[models.Interaction](self, models.Interaction)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/aryan/OneDrive/Desktop/Aryansh_Workspace/Development Project/DebateQuiestBackend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    quizzes: 'quizzesBatchActions'
    quiz_result: 'quiz_resultBatchActions'
    user_progress: 'user_progressBatchActions'
    bookmark_quiz: 'bookmark_quizBatchActions'
    debatesession: 'DebateSessionBatchActions'
    message: 'MessageBatchActions'
    companion_create: 'companion_createBatchActions'
    interaction: 'InteractionBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.quizzes = quizzesBatchActions(self)
        self.quiz_result = quiz_resultBatchActions(self)
        self.user_progress = user_progressBatchActions(self)
        self.bookmark_quiz = bookmark_quizBatchActions(self)
        self.debatesession = DebateSessionBatchActions(self)
        self.message = MessageBatchActions(self)
        self.companion_create = companion_createBatchActions(self)
        self.interaction = InteractionBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class user_progressBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class bookmark_quizBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class DebateSessionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class companion_createBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
